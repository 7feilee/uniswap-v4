...
func (_PoolManager *PoolManagerCaller) IsOperator(opts *bind.CallOpts, owner common.Address, spender common.Address) (bool, error) {
	var out []interface{}
	err := _PoolManager.contract.Call(opts, &out, "isOperator", owner, spender)
...
//
// Solidity: function isOperator(address owner, address spender) view returns(bool approved)
func (_PoolManager *PoolManagerSession) IsOperator(owner common.Address, spender common.Address) (bool, error) {
	return _PoolManager.Contract.IsOperator(&_PoolManager.CallOpts, owner, spender)
}

// IsOperator is a free data retrieval call binding the contract method 0xb6363cf2.
//
// Solidity: function isOperator(address owner, address spender) view returns(bool approved)
func (_PoolManager *PoolManagerCallerSession) IsOperator(owner common.Address, spender common.Address) (bool, error) {
	return _PoolManager.Contract.IsOperator(&_PoolManager.CallOpts, owner, spender)
}
...
func (_PoolManager *PoolManagerTransactor) Initialize(opts *bind.TransactOpts, key PoolKey, sqrtPriceX96 *big.Int, hookData []byte) (*types.Transaction, error) {
	return _PoolManager.contract.Transact(opts, "initialize", key, sqrtPriceX96, hookData)
}

// Initialize is a paid mutator transaction binding the contract method 0x695c5bf5.
//
// Solidity: function initialize((address,address,uint24,int24,address) key, uint160 sqrtPriceX96, bytes hookData) returns(int24 tick)
func (_PoolManager *PoolManagerSession) Initialize(key PoolKey, sqrtPriceX96 *big.Int, hookData []byte) (*types.Transaction, error) {
	return _PoolManager.Contract.Initialize(&_PoolManager.TransactOpts, key, sqrtPriceX96, hookData)
}

// Initialize is a paid mutator transaction binding the contract method 0x695c5bf5.
//
// Solidity: function initialize((address,address,uint24,int24,address) key, uint160 sqrtPriceX96, bytes hookData) returns(int24 tick)
func (_PoolManager *PoolManagerTransactorSession) Initialize(key PoolKey, sqrtPriceX96 *big.Int, hookData []byte) (*types.Transaction, error) {
	return _PoolManager.Contract.Initialize(&_PoolManager.TransactOpts, key, sqrtPriceX96, hookData)
}
...
//
// Solidity: function modifyLiquidity((address,address,uint24,int24,address) key, (int24,int24,int256,bytes32) params, bytes hookData) returns(int256 callerDelta, int256 feeDelta)
